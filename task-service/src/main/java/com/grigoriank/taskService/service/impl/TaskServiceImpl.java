package com.grigoriank.taskService.service.impl;

import com.grigoriank.taskService.entity.Task;
import com.grigoriank.taskService.entity.TaskStatus;
import com.grigoriank.taskService.repository.TaskRepository;
...
public class TaskServiceImpl implements TaskService {
    ...
    public List<Task> getAllTask(TaskStatus status) {
        ...
        List<Task> filteredTasks = allTask.stream().filter(task -> status == null || task
                        .getStatus().name().equalsIgnoreCase(status.toString()))
